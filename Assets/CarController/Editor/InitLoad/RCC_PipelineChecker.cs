...
public class RCC_PipelineChecker {
    ...
    public static void DelayedInitLoad() {
        ...
        if (decision == 2)
            EditorUtility.DisplayDialog("Realistic Car Controller | Materials", "Only Unity 6 version of the asset is compatible with HDRP. Upgrade your project to Unity 6000.0.25f1 at least to use HDRP. After opening the project with Unity 6, update RCC through Window --> Package Manager. Please read the readme text before importing the HDRP version.", "Ok");
